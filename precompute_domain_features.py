# This script computes the frequency of all domain types in the human proteome. The frequencies are used by DMI predictor to score DMI predictions. This scri[t takes a domain type files and returns a new file that contains annotation of the frequency of the domain in the human proteome.
# Author: Chop Yan Lee
...
def calculate_domain_frequency(domain_type_file):
    """
    Calculate the two types of domain frequencies for all the domain types in the input domain_type_file. The two types of domain frequencies are:
    DomainFreqbyProtein: Frequency of the domain type calculated as the fraction of human SwissProt proteins having at least one match of the HMM of the domain type
    DomainFreqinProteome: Frequency of the domain type calculated through the frequency of the HMM of the domain type matching in the human SwissProt proteins
    The frequencies are appended as columns to the domain_type_file and saved with the suffix _with_frequency.

    Args:
        domain_type_file (str): Absolute path to the file containing all domain types
    """
